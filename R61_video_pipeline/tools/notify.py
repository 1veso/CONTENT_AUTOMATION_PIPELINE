"""
Best-effort Telegram progress notifications for R61.

Reads `TELEGRAM_BOT_TOKEN` and `TELEGRAM_CHAT_ID` from the environment.
Inside Modal these come from the `r61-secrets` Modal secret. Locally they
come from `.env`.
...
Operator setup (Modal):
    modal secret update r61-secrets \\
