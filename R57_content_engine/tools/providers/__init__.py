...
Usage:
    ...
    provider, name = get_image_provider("nano-banana-pro", "fal")   # Fal.ai (override)
    provider, name = get_video_provider("veo-3.1")                  # Google (default)
    provider, name = get_video_provider("kling-3.0")                # WaveSpeed (default)
"""

from . import fal, google, wavespeed

# --- Image model registry ---
IMAGE_PROVIDERS = {
    "nano-banana": {
        "default": "google",
        "providers": {"google": google, "fal": fal},
    },
    "nano-banana-pro": {
        "default": "google",
        "providers": {"google": google, "fal": fal},
...
VIDEO_PROVIDERS = {
    "kling-3.0": {
        "default": "wavespeed",
        "providers": {"fal": fal, "wavespeed": wavespeed},
    },
    "sora-2": {
        "default": "wavespeed",
        "providers": {"wavespeed": wavespeed},
...
def get_image_provider(model="nano-banana-pro", provider_override=None):
    ...
    Args:
        ...
        provider_override: Force a specific provider (e.g., "fal")
...
def is_sync(provider_module, generation_type):
    ...
    Args:
        provider_module: The provider module (e.g., google, fal)
